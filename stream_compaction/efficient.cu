...
namespace StreamCompaction {
    namespace Efficient {
        ...
        void scan(int n, int *odata, const int *idata) {
            ...
            dim3 fullBlocksPerGrid((fit_size / blockSize) + 1);
            ...
            for (int d = 0; d <= d_max; ++d) {
                ...
                dim3 up_sweep_blocks_per_grid((threads_num_needed / blockSize) + 1);
            ...
            for (int d = d_max; d >= 0; --d) {
                ...
                int deno = 1 << (d + 1);
                int threads_num_needed = fit_size / deno;
                dim3 down_sweep_blocks_per_grid((threads_num_needed / blockSize) + 1);
        ...
        int compact(int n, int *odata, const int *idata) {
            ...
            dim3 scanFullBlocksPerGrid((fit_size / blockSize) + 1);
